...
[InstallDelete]
; 改名前的快捷方式名，安装器升级时一并清掉，避免桌面上出现两个图标。
...
[Icons]
Name: "{group}\AgentNotify"; Filename: "{app}\agent-notify.exe"; Parameters: "widget"
Name: "{userdesktop}\AgentNotify"; Filename: "{app}\agent-notify.exe"; Parameters: "widget"; Tasks: desktopicon
Name: "{userstartup}\AgentNotify"; Filename: "{app}\agent-notify.exe"; Parameters: "widget"; Tasks: startupicon

[Run]
Filename: "{app}\agent-notify.exe"; Parameters: "widget"; Description: "启动 AgentNotify"; Flags: nowait postinstall
